...
{
	size_t l;								// ligne: [0..LIG-1] -- colonne: [0..COL-1]
	size_t c;
};
...
{
	Color color; 							// le membre 'c' est le caractère à utiliser pour l'affichage
	char c;
};

Style map[5] =								// les style pour toutes les cases // a comparer avec enum Case {}.
{
...
int main()
{
	...
	showcurs(true);										// afficher (oui/non) le trait d'affichage de la console
